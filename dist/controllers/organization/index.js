...
exports.addDepartmentToOrganization = exports.getOrganizationByEmail = exports.deleteOrganization = exports.getAllSummary = exports.getOrganizations = exports.getOrganizationSummary = exports.getOrganizationDetails = exports.resendActivationLink = exports.confirmEmail = exports.createOrganization = void 0;
...
async function getOrganizations(req, res) {
    try {
        console.log(req);
        const organizations = await organization_1.default.find({}).select({
            title: 1,
            isVerified: 1,
            description: 1,
            _id: 0,
...
async function getAllSummary(req, res) {
    try {
        console.log(req);
        const organizationsCount = await organization_1.default.find({}).count();
