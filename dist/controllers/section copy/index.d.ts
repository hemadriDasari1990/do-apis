...
export declare function createSectionActivity(sectionId: string, action: string, userId?: string): Promise<any>;
...
export declare function deleteSection(sectionId: string, userId: string): Promise<any>;
