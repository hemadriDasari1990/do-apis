...
export declare function getNoteDetails(noteId: string): Promise<any>;
export declare function markNoteRead(payload: {
    [Key: string]: any;
}): Promise<any>;
export declare function deleteNote(payload: {
    [Key: string]: any;
}): Promise<any>;
export declare function addReactionToNote(reactionId: string, noteId: string): Promise<any>;
export declare function updateNoteSectionId(noteId: string, sectionId: string): Promise<any>;
