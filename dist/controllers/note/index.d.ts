...
export declare function createNote(req: Request, res: Response, next: NextFunction): Promise<any>;
export declare function updateNote(req: Request, res: Response, next: NextFunction): Promise<any>;
export declare function getAllNotes(req: Request, res: Response): Promise<any>;
