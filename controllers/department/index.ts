...
export async function getDepartmentDetails(req: Request, res: Response): Promise<any> {
  try {
...
export async function deleteDepartment(req: Request, res: Response, next: NextFunction): Promise<any> {
  try {
...
export async function addProjectToDepartment(projectId: string, departmentId: string) : Promise<any> {
  try {
